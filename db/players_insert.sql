...
VALUES ('Terrestri', @user_id, '19000101', '30000101', 'IT', 1);
...
VALUES (@team_id, @player_id, '19000101', '30000101');
...
INSERT INTO `matterhorn`.`TEAMS` (`description`,`owner`,`creation_date`,`end_date`,`country`,`active`)
VALUES ('Alieni', @user_id, '19000101', '30000101', 'IT', 1);
...
## Inserimento partita test Alieni vs Terrestri
INSERT INTO `matterhorn`.`MATCHES` (due_date, country, league_id, season_id, week, home_team_id, home_team_formation_id, away_team_id, away_team_formation_id)
VALUES ('20160701', 'IT', 1, 1, 1, 1, '352', 2, '442');

## Inserimento giocatori in formazioni partita test

INSERT INTO `matterhorn`.`MATCHES_FORMATIONS` (`match_id`,`team_id`,`position`,`player_id`,`match_time`)
# Team 2
SELECT 1, 1, 1, 1, 0 UNION ALL
SELECT 1, 1, 3, 2, 0 UNION ALL
SELECT 1, 1, 5, 3, 0 UNION ALL
SELECT 1, 1, 2, 4, 0 UNION ALL
SELECT 1, 1, 6, 5, 0 UNION ALL
SELECT 1, 1, 8, 6, 0 UNION ALL
SELECT 1, 1, 10, 7, 0 UNION ALL
SELECT 1, 1, 7, 8, 0 UNION ALL
SELECT 1, 1, 11, 9, 0 UNION ALL
SELECT 1, 1, 13, 10, 0 UNION ALL
SELECT 1, 1, 15, 11, 0 UNION ALL
SELECT 1, 1, 15, 12, 45 UNION ALL
# Team 1
SELECT 1, 2, 1, 13, 0 UNION ALL
SELECT 1, 2, 3, 14, 0 UNION ALL
SELECT 1, 2, 5, 15, 0 UNION ALL
SELECT 1, 2, 2, 16, 0 UNION ALL
SELECT 1, 2, 6, 17, 0 UNION ALL
SELECT 1, 2, 8, 18, 0 UNION ALL
SELECT 1, 2, 10, 19, 0 UNION ALL
SELECT 1, 2, 7, 20, 0 UNION ALL
SELECT 1, 2, 11, 21, 0 UNION ALL
SELECT 1, 2, 13, 22, 0 UNION ALL
SELECT 1, 2, 15, 23, 0 UNION ALL
SELECT 1, 2, 15, 24, 48;
